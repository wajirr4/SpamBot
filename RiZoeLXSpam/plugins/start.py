...
Riz_Button = [
        [
        Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/xteambdchat")
        ],
        [
...
RizX_Button = [
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/Xteambd"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/xteambdchat")
        ],
        [
        Button.url("• Owner •", "https://t.me/botmakerBD")
        ]
        ]
...
async def start(event):              
    if event.is_private:
       ...
       usermsg = f"**Hello, {firstname} ! Nice To Meet You, Well I Am {bot_id}, An Powerfull Spam Bot.** \n\n**If You Want Your Own Spam Bots You Can Deploy From Button Below.** \n\n**𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 [BotMakerBD](https://t.me/BotMakerBD)**"
